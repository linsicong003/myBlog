<template>
  <div class="home-blog" :class="recoShow?'reco-show': 'reco-hide'">
    <div class="hero" :style="{ ...bgImageStyle}">
      <h1>{{ data.heroText || $title || 'Clancy' }}</h1>

      <p class="description">{{ data.tagline || $description || 'Welcome to my blog' }}</p>
    </div>

    <div class="home-blog-wrapper">
      <!-- 博客列表 -->
      <note-abstract class="blog-list" :data="posts" :isHome="true" :currentPage="1"></note-abstract>
...
.home-blog {
  ...
  .hero {
    background: url('/image/background/6.jpg') no-repeat;
