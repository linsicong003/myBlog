...
![元素节点](https://raw.githubusercontent.com/linsicong003/blog-img/master/20190907-4.png)

接着我们继续取它的子元素，很明显它的子元素就是一段纯粹的文本了，那么具体究竟是不是这样的呢？我们继续往下实践来看一看：

![文本节点](https://raw.githubusercontent.com/linsicong003/blog-img/master/20190907-5.png)
