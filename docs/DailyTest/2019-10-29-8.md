...
![lodash代码实现一角](https://raw.githubusercontent.com/linsicong003/blog-img/master/20191029-1.png)

每个 `引用类型` 都可以通过 `toString` 方法来获取准确的引用类型。

![对应类型表](https://raw.githubusercontent.com/linsicong003/blog-img/master/20191029-2.jpg)
